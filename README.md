# Финансовый радар
Разработка системы мониторинга финансовых операций в реальном времени для выявления мошеннических паттернов

## Архитектура приложения
![картинка](https://github.com/user-attachments/assets/429c3d11-c5f3-4496-8a84-27d1f12494b1)
...
4. Запустить модули приложения в IDE в порядке:
- RuleService
- TransactionalService
- NotificationService
- AdminPanel 

5. Доступ осуществляется локально
